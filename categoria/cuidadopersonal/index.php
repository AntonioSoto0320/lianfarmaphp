...
<div class="container-card">
    ...
    $sql = "SELECT * FROM `productos` WHERE categoria='CP';";
        ...
        <div class="card">
            ...
            <div class="contentBx">
                ...
                <form action="../../funciones/agregar_carrito.php" method="post">
                    ...
                    <input type="hidden" name="id_categoria" value="http://localhost:80/lianfarma/categoria/cuidadopersonal/">
